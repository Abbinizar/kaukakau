    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#home-sec">Beranda</a></li>
                <li><a href="#services-sec">Fitur</a></li>
                <li><a href="#price-sec">Tentang</a></li>
                <li><a href="http://localhost/kaukakau/?c=kontrol_halaman&f=login_page">Login</a></li>
            </ul>
        </div>
